...
namespace STAWebsite2.Controllers
{
    public class CourseController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CourseID,Title,avgSCRating,verificationCode,InstructorID")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CourseID,Title,avgSCRating,verificationCode,InstructorID")] Course course)
        {
            if (ModelState.IsValid)
            {
